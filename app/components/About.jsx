...
const About = () => {
  ...
  return (
    <div id="about" className="w-full px-4 sm:px-[8%] lg:px-[12%] py-16 bg-white">
    {/* Header */}
    <div className="text-center mb-4">
      ...
      <div className="flex justify-center items-center gap-2 mt-5 mb-8"><SiGithub className="w-6 h-6" />: <a href="https://github.com/SumYu02" target="_blank" rel="noopener noreferrer">SumYu02</a></div>
            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap gap-3">
                {category.skills.map((skill, skillIdx) => (
                  ...
                  >
                    <span className={`text-2xl ${skill.color} group-hover/skill:scale-110 transition-transform duration-300`}>
                      {skill.icon}
                    </span>
