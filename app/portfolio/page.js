        ...
        <div className="w-full px-[12%] pt-10 ml-2 scroll-mt-20 flex-1">
          ...
          <div>
            ...
            <p className="mt-20 text-lg text-gray-600 text-center max-w-2xl mx-auto">
              ...
              you&apos;re checking out my work, downloading my resume, or
          ...
          <div className="mt-6">
            <p className="text-gray-600 text-md text-justify max-w-4xl mx-auto">
              ...
              without the need for a backend. The project was created to deepen
              my understanding of component-based development and responsive
              design using modern frontend technologies. It emphasizes clean UI,
              a modular structure, and hands-on experience with the React and
              Tailwind CSS ecosystem. Additionally, the site showcases projects
